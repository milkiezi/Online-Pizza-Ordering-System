...
<table>
				...
				while($row = mysqli_fetch_array($result))
				{
					...
					echo '<td><label for="balance">Balance</label><input id="balance" name="'.$row['user_id'].'_balance" value="'.$balance.'" type="number" data-error=".errorTxt01"><div class="errorTxt01"></div></td></tr>'; 					
				}
				?>
                    </tbody>
</table>
