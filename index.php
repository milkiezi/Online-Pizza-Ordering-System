            ...
            <div class="row">
              ...
              <div>
				...
				while($row = mysqli_fetch_array($result))
				{
					...
					echo '<td><div class="input-field col s12"><label for='.$row["item_id"].' class="">Quantity</label>';
					echo '<input value= 0 id="'.$row["item_id"].'" name="'.$row['item_id'].'" type="text" data-error=".errorTxt'.$row["item_id"].'"><div class="errorTxt'.$row["item_id"].'"></div></td></tr>';
				}
				?>
                    </tbody>
</table>
